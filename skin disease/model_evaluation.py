...
model_paths = {
    'bagging': r'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\models\\bagging_model.pkl',
    'adaboost': r'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\models\\adaboost_model.pkl',
    'hist_gradient_boosting': r'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\models\\hist_gradient_boosting_model.pkl',
    'extra_trees': r'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\models\\extra_trees_model.pkl'
}
val_features_path = r'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\val_hog_features.pkl'
val_labels_path = r'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\val_labels.npy'
selector_path = r'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\models\\feature_selector.pkl'
label_encoder_path = r'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\models\\label_encoder.pkl'
...
train_labels = np.load('C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\features\\train_labels.npy')
val_labels = np.load('C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\features\\val_labels.npy')

train_hog_features = load_hog_features('C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\features\\train_hog_features.pkl')
val_hog_features = load_hog_features('C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\features\\val_hog_features.pkl')
...
#
# Define paths
val_labels_path = 'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\features\\val_labels.npy'
val_hog_features_path = 'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\features\\val_hog_features.pkl'
models_dir = 'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\models'
...
# Define class names
class_names = ['actinic keratosis','basal cell carcinoma','dermatofibroma','melanoma','nevus','normal skin',
