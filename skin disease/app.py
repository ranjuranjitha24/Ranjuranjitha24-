...
app = Flask(__name__, template_folder=r'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\templates', 
            static_folder=r'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\static')
app.secret_key = "supersecretkey"

# Define paths and file locations
models_dir = r'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\models'
model_paths = {
...
val_hog_features = pickle.load(open('C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\features\\val_hog_features.pkl', 'rb'))
...
def predict():
    ...
    if file and allowed_file(file.filename):
        ...
        file_path = os.path.join(r'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\features\uploads', filename)
        file.save(file_path)
        ...
        try:
            ...
            file_path = os.path.join(r'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\features\\uploads', 'captured_image.png')
...
def uploaded_file(filename):
    return send_from_directory(r'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\features\\uploads', filename)

# Ensure uploads directory exists
if __name__ == '__main__':
    os.makedirs(r'C:\\Users\\user\\Desktop\\DD\\Skin-disease-detection\\features\\uploads', exist_ok=True)
    app.run(debug=True)
