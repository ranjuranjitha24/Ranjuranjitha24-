...
train_features_path = r'C:\Users\user\Desktop\DD\Skin-disease-detection\features\train_hog_features.pkl'  # Path to training HOG features
train_labels_path = r'C:\Users\user\Desktop\DD\Skin-disease-detection\features\train_labels.npy'  # Path to training labels
models_dir = r'C:\Users\user\Desktop\DD\Skin-disease-detection\models'  # Directory where the trained models will be saved
